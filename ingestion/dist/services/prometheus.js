...
exports.renderIngestionPrometheusMetrics = renderIngestionPrometheusMetrics;
const metrics_1 = require("./metrics");
function renderIngestionPrometheusMetrics() {
    const lines = [];
    ...
    lines.push(`iotistic_ingestion_stream_length ${metrics_1.metrics.streamLength}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_worker_lag ${metrics_1.metrics.workerLag}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_pending_count ${metrics_1.metrics.pendingMessages}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_dlq_length ${metrics_1.metrics.dlqLength}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_worker_count ${metrics_1.metrics.workerCount}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_redis_connected ${metrics_1.metrics.redisConnected}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_redis_memory_used_bytes ${metrics_1.metrics.redisMemoryUsedBytes}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_redis_memory_max_bytes ${metrics_1.metrics.redisMemoryMaxBytes}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_batch_latency_p95_ms ${metrics_1.metrics.getBatchLatencyP95()}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_insert_latency_p95_ms ${metrics_1.metrics.getInsertLatencyP95()}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_dwell_latency_p95_ms ${metrics_1.metrics.getDwellLatencyP95()}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_messages_processed_total ${metrics_1.metrics.messagesProcessed}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_readings_inserted_total ${metrics_1.metrics.readingsInserted}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_messages_failed_total ${metrics_1.metrics.messagesFailed}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_messages_dropped_total ${metrics_1.metrics.messagesDropped}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_oom_errors_total ${metrics_1.metrics.oomErrors}`);
    lines.push('');
    ...
    lines.push(`iotistic_ingestion_redis_reconnects_total ${metrics_1.metrics.redisReconnects}`);
    return `${lines.join('\n')}\n`;
}
