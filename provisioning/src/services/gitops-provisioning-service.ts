  ...
  private generateApplicationManifest(data: ClientDeploymentData): any {
    return {
      ...
      metadata: {
        ...
        finalizers: [
          // Ensure deleting the Argo CD Application cascades deletion of managed resources.
      ...
      spec: {
        ...
        syncPolicy: {
          ...
          syncOptions: [
            ...
            // Use foreground propagation so child resources are fully removed on prune/delete.
            'PrunePropagationPolicy=foreground',
            // Apply regular sync first, then prune leftover resources as a final step.
            'PruneLast=true',
          ],
        },
      },
