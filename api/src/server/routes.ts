...
import usersRoutes from '../routes/auth/users';
import invitesRoutes from '../routes/auth/invites';
...
import provisioningRoutes from '../routes/provisioning/index';
import agentsRoutes from '../routes/agent/agents';
import adminRoutes from '../routes/admin';
import deviceJobsRoutes from '../routes/agent/jobs';
import rotationRoutes from '../routes/auth/rotation';
...
import profileRoutes from '../routes/telemetry/profiles';
import aiChatRoutes from '../routes/ai/ai-chat';
import dashboardAiRoutes from '../routes/ai/dashboard-ai';
import licenseRoutes from '../routes/auth/license';
