      ...
      <div className="px-6 md:px-8 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center cursor-pointer" onClick={onHomeClick}>
          <div className="leading-snug">
            ...
            <p style={{ fontSize: '1rem' }} className="font-semibold text-muted-foreground mt-1">Your Edge Management Platform <span className="text-xs text-gray-500">v{__APP_VERSION__}</span></p>
          </div>
        </div>
